...
> **⚠️ PROJECT-SPECIFIC NOTE: ORM Selection**
>
> **This project uses Prisma ORM, not Drizzle.**
>
> While Neon supports multiple ORMs (Drizzle, Prisma, Kysely), this specific project has standardized on:
> - **Prisma ORM** for database operations
> - **@prisma/adapter-neon** for Neon serverless driver integration
> - **Prisma MCP Server** for AI-assisted schema management
>
> **Reference this project's Prisma guides instead of Drizzle resources:**
...
>
> For Neon platform API operations (branches, projects, compute endpoints), continue using the TypeScript SDK resources below.
