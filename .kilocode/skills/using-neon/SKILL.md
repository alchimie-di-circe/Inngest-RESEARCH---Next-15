...
> **⚠️ PROJECT-SPECIFIC NOTE: ORM & MCP Selection**
>
> **This project uses:**
> - **Prisma ORM** (not Drizzle) for database operations
> - **@prisma/adapter-neon** for Neon serverless driver integration
> - **Neon MCP Server** (connected) for AI-assisted database operations (branches, projects, endpoints)
>
> **Stack:**
> - **ORM**: Prisma CLI (`npx prisma migrate`, `generate`) - run in Codespace per AGENTS.md
> - **Database Ops**: Neon MCP tools (`list_branches`, `create_branch`, `get_connection_string`, etc.)
> - **Neon Project**: `summer-haze-17190561` with branches: production, preview, dev
>
> **Reference this project's Prisma guides:**
> - [docs/prisma/neon-guide.md](../../docs/prisma/neon-guide.md) - Neon + Prisma setup
> - [docs/prisma/best-practices.md](../../docs/prisma/best-practices.md) - Prisma patterns
> - [docs/prisma/quickstart.md](../../docs/prisma/quickstart.md) - Quick start
>
> **For Neon platform operations (branches, projects):** Use Neon MCP server or TypeScript SDK resources below.
