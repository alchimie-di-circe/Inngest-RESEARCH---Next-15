...
description: useAgent hook and streaming patterns
alwaysApply: false
---
...
Type Safety: Tool names, inputs, and outputs are fully typed based on your ToolManifest
Real-time Streaming: See tools execute in real-time with different states (input-streaming, input-available, executing, output-available)
