---
tags: [inngest, mcp, guides, cloud, all-agents]
description: Inngest MCP server quick start
alwaysApply: false
---

## Inngest Devserver MCP - Quick Start
...
Use send_event to trigger the function
Use poll_run_status to monitor execution
Show you step-by-step progress and final results
Report any errors with detailed context
...
Send multiple coordinated events
Monitor all resulting function runs
Verify the entire workflow completes
Report any failures or timeouts
