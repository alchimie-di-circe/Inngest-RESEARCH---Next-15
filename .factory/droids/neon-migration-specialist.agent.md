...
**This project's Neon setup:**
- **Project ID**: `summer-haze-17190561`
- **ORM**: Prisma (use `npx prisma migrate dev` for schema migrations)
- **Existing Neon branches**: 
...
- **Neon MCP available**: Use `list_branches`, `create_branch`, `execute_sql` tools when available

**For more context**, see:
- [docs/prisma/neon-guide.md](../../docs/prisma/neon-guide.md) - Prisma + Neon setup
- [docs/neon/api-reference/branches.md](../../docs/neon/api-reference/branches.md) - Branch API reference
- [AGENTS.md](../../AGENTS.md) - Full development workflow guide
